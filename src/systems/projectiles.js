...
(() => {
  ...
  function shootProjectile(context, monster, target, angleOffset = 0) {
    ...
    const midbossColor = monster.type === "warden" ? "#6de4ff" : monster.type === "obsidianGolem" ? "#aab0c8" : "#55c7a0";
    const projectileColor = monster.type === "bubbler" ? "#8dd7ff" : monster.type === "voidDragon" ? "#d8d8ff" : monster.type === "voidWraith" ? "#7b80d8" : monster.type === "obsidianCrawler" || monster.type === "obsidianGolem" ? "#aab0c8" : monster.type === "eclipseDragon" ? "#f06dff" : monster.type === "eclipseMage" ? "#e36dff" : monster.type === "moonShade" ? "#7f8cff" : monster.type === "sorcerer" ? "#b990ff" : monster.boss ? "#ff543d" : monster.midboss ? midbossColor : "#ffd166";
    ...
    const speed = (monster.type === "voidDragon" ? 94 : monster.type === "voidWraith" || monster.type === "obsidianCrawler" ? 88 : monster.type === "eclipseDragon" ? 86 : monster.boss ? 78 : monster.type === "obsidianGolem" ? 60 : monster.midboss ? 68 : monster.type === "bubbler" ? 52 : monster.type === "eclipseMage" ? 82 : monster.type === "moonShade" ? 76 : monster.type === "sorcerer" ? 70 : 62) * WORLD_SCALE;
    state.projectiles.push({
      ...
      damage: monster.type === "voidDragon" ? 23 : monster.type === "obsidianGolem" ? 18 : monster.type === "voidWraith" || monster.type === "obsidianCrawler" ? 15 : monster.type === "eclipseDragon" ? 18 : monster.boss ? 14 : monster.midboss ? 11 : monster.type === "bubbler" ? 6 : monster.type === "eclipseMage" ? 13 : monster.type === "moonShade" ? 11 : monster.type === "sorcerer" ? 10 : 8,
    ...
    state.projectiles = state.projectiles.filter((p) => {
      ...
      if (rectsOverlap(player, hitbox)) {
        if (player.invuln <= 0 && player.hp > 0) {
          const source = p.source === "obsidianGolem" || p.source === "obsidianCrawler" ? "obsidian" : p.source === "voidDragon" || p.source === "voidWraith" ? "void" : p.source === "eclipseDragon" || p.source === "eclipseMage" ? "eclipse" : p.source === "wisp" || p.source === "dragon" ? "fire" : p.source === "bubbler" ? "bubble" : p.source === "sorcerer" || p.source === "moonShade" || p.source === "ashKnight" ? "magic" : "projectile";
          ...
          if (p.source === "wisp" || p.source === "dragon") {
          ...
          } else if (p.source === "sorcerer" || p.source === "moonShade" || p.source === "ashKnight" || p.source === "eclipseMage" || p.source === "eclipseDragon" || p.source === "voidWraith" || p.source === "voidDragon" || p.source === "obsidianCrawler" || p.source === "obsidianGolem") {
            ...
            const baseSlow = p.source === "voidDragon" ? 1900 : p.source === "obsidianGolem" ? 1700 : p.source === "voidWraith" || p.source === "obsidianCrawler" ? 1350 : p.source === "eclipseDragon" ? 1500 : p.source === "ashKnight" ? 1200 : p.source === "eclipseMage" ? 1100 : p.source === "moonShade" ? 980 : 760;
            const baseStamina = p.source === "voidDragon" ? 26 : p.source === "obsidianGolem" ? 22 : p.source === "voidWraith" || p.source === "obsidianCrawler" ? 17 : p.source === "eclipseDragon" ? 18 : p.source === "ashKnight" ? 14 : p.source === "eclipseMage" ? 13 : p.source === "moonShade" ? 11 : 8;
