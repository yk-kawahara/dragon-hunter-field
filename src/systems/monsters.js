...
(() => {
  ...
  function defeatMonster(context, monster) {
    ...
    } else if (monster.midboss && !["obsidianGolem", "smugglerCaptain", "regenSentinel", "mistKeeper", "cryptWarden", "archiveWarden", "frostGolem", "towerWarden", "solarWarden", "sunspireKeeper"].includes(monster.type)) {
