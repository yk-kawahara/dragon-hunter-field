...
(() => {
  ...
  const TERRAIN_DETAILS = [
    ...
    { id: "moon-cavern-mouth", x: 92, y: 103, rows: ["C"] },
    { id: "moon-camp-cavern-gate", x: 95, y: 115, rows: ["C"] },
    { id: "moon-cavern", x: 122, y: 24, rows: [
      "###################################",
      "#C____++++____####____++++________#",
      "#_####+__+____#..#____+__+__###___#",
      "#____+++++____#..#____++++____#___#",
      "#_++____#####_####_#####____++#___#",
      "#_++____+___+______+___+____++____#",
      "#_####__+___+__**__+___+__####____#",
      "#____+__+++++__**__+++++__+_______#",
      "####_+_________++++________+_####_#",
      "#____+_####____+__+____####+______#",
      "#_++++_#..#____++++____#..#_++____#",
      "#_+____####____________####_+_____#",
      "#_+_________+++++____________+____#",
      "#_#######___+___+___#######__+____#",
      "#_______+___+++++___+_______++____#",
      "#___++__+___________+__++____#____#",
      "#___++__#####___#####__++____#____#",
      "#_______+___+___+___+_______++____#",
      "#_####__+___+___+___+__####_+_____#",
      "#____+__+++++___+++++__+____+__C__#",
    ...
    { id: "black-gate-forward-post", x: 61, y: 132, rows: [
      "..==..++++..",
      "..**..++++..",
    ] },
    { id: "black-gate-lookout", x: 80, y: 130, rows: [
      "..##..++++..",
      "..==..++++..",
      "......++....",
    ] },
  ...
  const OVERVIEW_CLEAR_AREAS = [
    ...
    { x1: 122, y1: 24, x2: 156, y2: 45, tile: "." },
  ...
  const OVERVIEW_TERRAIN = [
    ...
    { id: "moon-cavern-overview-range", tile: "#", width: 2, points: [[124, 36], [136, 28], [154, 39]] },
  ...
  const OVERVIEW_LANDMARKS = [
    ...
    { id: "moon-cavern", x: 140, y: 36, rows: [".###.", "#.C.#", "#+++#", ".###."] },
  ...
  const WORLD_OBJECTS = [
    ...
    { type: "npc", npcType: "frontier", x: 35, y: 32, offsetX: 3, offsetY: 2, w: 10, h: 12, dir: "down" },
    { type: "npc", npcType: "guide", x: 37, y: 34, offsetX: 3, offsetY: 2, w: 10, h: 12, dir: "left" },
    { type: "npc", npcType: "porter", x: 32, y: 35, offsetX: 3, offsetY: 2, w: 10, h: 12, dir: "right" },
    { type: "npc", npcType: "villager", x: 32, y: 32, offsetX: 3, offsetY: 2, w: 10, h: 12, dir: "down" },
