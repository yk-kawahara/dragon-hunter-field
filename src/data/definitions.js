...
(() => {
  ...
  const TREASURE_CHESTS = [
    ...
    { id: "dragon-approach-cache", x: 49, y: 27, reward: "dragonApproachSupply" },
    ...
    { id: "moon-cavern-mid-cache", x: 136, y: 34, reward: "moonCavernSupply" },
    { id: "moon-cavern-exit-cache", x: 145, y: 38, reward: "moonCavernExitSupply" },
    { id: "moon-cavern-reliquary", x: 153, y: 41, reward: "moonCavernRelic" },
    ...
    { id: "black-gate-forward-cache", x: 68, y: 134, reward: "blackGateSupply" },
    { id: "black-gate-final-cache", x: 86, y: 132, reward: "blackGateSupply" },
    ...
    { id: "suncrest-approach-cache", x: 234, y: 116, reward: "suncrestApproachSupply" },
  ...
  const DISCOVERY_POINTS = [
    ...
    { id: "suncrest-approach-post", x: 235, y: 117, kind: "suncrestApproachHint" },
  ...
  const REGION_SPAWNS = {
    ...
    dragonApproach: { danger: 4, maxBonus: 4, pool: ["dragonling", "wisp", "dragonling", "boar"] },
    ...
    moonCavern: { danger: 7, maxBonus: 8, pool: ["moonShade", "summoner", "shieldSoldier", "sorcerer", "trapFlower"] },
  ...
  const armorDefense = [0, 2, 5, 11, 17, 7, 9, 27, 24, 29, 37, 46, 52, 66];
  ...
  const shieldGuard = [0, 0.8, 0.64, 0.58, 0.52, 0.4, 0.3, 0.24];
