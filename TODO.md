...
\* Add `AGENTS.md` and align future development around survival range expansion rather than quest checklist progression.
...
\## Village and Recovery Loop



\* Make the village feel more clearly like a safe recovery point.

\* Ensure the player can easily understand where to heal, buy gear, and restock.
